...
<span style="font-size: 100%; color:#FFFF00"> Do you work remotely on cloud and HPC? </span> <!-- .element: class="fragment" -->

<span style="font-size: 100%; color:#FFFF00"> Use (Distributed) Data Management Systems? </span> <!-- .element: class="fragment" -->

<span style="font-size: 100%; color:#FFFF00"> Engage with Workflow Management Systems? </span> <!-- .element: class="fragment" -->
